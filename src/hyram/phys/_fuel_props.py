...
class FuelProperties:
    ...
    _data = {
        "H2": {"LFL": 0.04, "UFL": 0.75, "dHc": 1.20e08, "other_name": "hydrogen"},
        "CH4": {"LFL": 0.05, "UFL": 0.15, "dHc": 5.00e07, "other_name": "methane"},
        "C3H8": {"LFL": 0.021, "UFL": 0.095, "dHc": 4.64e07, "other_name": "n-Propane"},
        "N2": {"LFL": np.nan, "UFL": np.nan, "dHc": 0, "other_name": "nitrogen"},
        "H2O": {"LFL": np.nan, "UFL": np.nan, "dHc": 0, "other_name": "Water"},
        "CarbonDioxide": {"LFL": np.nan, "UFL": np.nan, "dHc": 0, "other_name": "CO2"},
        "CarbonMonoxide": {
            "LFL": 0.125,
            "UFL": 0.74,
            "dHc": 1.01e7,
        ...
        "C2H6": {"LFL": 0.03, "UFL": 0.124, "dHc": 4.75e7, "other_name": "ethane"},
        "n-Butane": {
            "LFL": 0.018,
            "UFL": 0.084,
            "dHc": 4.57e7,
    ...
    def __init__(self, species):
        if not misc_utils.is_parsed_blend_string(species):
            ...
            if species not in list(self._data.keys()):
                if species.lower() not in [
                    fuel["other_name"].lower() for fuel in self._data.values()
                ]:
                    ...
                    species = [
                        ...
                        if v["other_name"].lower() == species.lower()
                    ][0]
            ...
            for species, X, Y in zip(specnames, molefracs, massfracs):
                if species.upper() not in [fuel.upper() for fuel in self._data.keys()]:
                    ...
                    species = [
                        k for k in self._data.keys() if k.lower() == species.lower()
                    ][0]
    ...
    def _count_atoms(species):
        if "hydrogen" in species.lower() or species == "H2":
            nC, nH, nO = 0, 2, 0
        elif "methane" in species.lower() or species == "CH4":
            nC, nH, nO = 1, 4, 0
        elif "ethane" in species.lower() or species == "C2H6":
            nC, nH, nO = 2, 6, 0
        elif "propane" in species.lower() or species == "C3H8":
            nC, nH, nO = 3, 8, 0
        elif "butane" in species.lower():
            nC, nH, nO = 4, 10, 0
        elif "pentane" in species.lower():
            nC, nH, nO = 5, 12, 0
        elif "hexane" in species.lower():
            nC, nH, nO = 6, 14, 0
        elif "carbondioxide" in species.lower():
            nC, nH, nO = 1, 0, 2
        elif "carbonmonoxide" in species.lower():
            nC, nH, nO = 1, 0, 1
        elif "nitrogen" in species.lower() or species == "N2":
            nC, nH, nO = 0, 0, 0
        elif "water" in species.lower() or species == "H2O":
            nC, nH, nO = 0, 2, 1
        return nC, nH, nO
